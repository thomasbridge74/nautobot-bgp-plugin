...
class ASNListView(generic.ObjectListView):
    ...
    table = ASNTable
    action_buttons = ()
    template_name = "nautobot_bgp_plugin/asn_list.html"
...
class CommunityListView(generic.ObjectListView):
    ...
    action_buttons = ()
    template_name = "nautobot_bgp_plugin/community_list.html"
...
class BGPSessionListView(generic.ObjectListView):
    ...
    action_buttons = ()
    template_name = "nautobot_bgp_plugin/bgpsession_list.html"
...
class RoutingPolicyListView(generic.ObjectListView):
    ...
    action_buttons = ()
    template_name = "nautobot_bgp_plugin/routingpolicy_list.html"
...
class BGPPeerGroupListView(generic.ObjectListView):
    ...
    action_buttons = ()
    template_name = "nautobot_bgp_plugin/bgppeergroup_list.html"
